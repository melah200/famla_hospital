...
$query=mysqli_query($db_connect, "SELECT `id`, `name`, `category`, `price`, `quantity`, `genericname`, `company`, `effect`, `expiredate` FROM addnewmedicine")or die (mysqli_error($db_connect));
