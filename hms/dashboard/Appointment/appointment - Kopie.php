...
{ 
  // $d1=date('Y-m-d');
$patient=html($_POST['fullname']);
$remark=html($_POST['remark']);
$doctor=html($_POST['doctor']);
$date=html($_POST['date']);
$starttime=html($_POST['time']);
$endtime = date('G:i', strtotime($starttime) + (30 * 60));

// print_r($endtime);
// die("");
 $q = "INSERT INTO addappointment( `patient`,`doctor`,`app_date`,`starttime`,`endtime`,`remark`,`sms`,`app_status`) VALUES ('100','$doctor','$date','$starttime','$endtime','$remark','0','upcoming')";
 $write =mysqli_query($db_connect, $q) or die(mysqli_error($db_connect));
...
<div class="modal-dialog">
  ...
  <div class="modal-body">
        <form method="POST" enctype="multipart/form-data">
           ...
           <div class="form-group">
               <label for="time-app">Time (30 min. Interval) <span style="color:red">*</span></label>
              <input type="time" name="time" step="1800" min="07:30" max="17:30" class="form-control" id="time-app" placeholder="" required>
           </div>
