	  ...
	  <legend>Activities</legend>
			...
			<div class="record-tab text-center" id="btn-ctrl-activities" style="display:none">
			  <tr>
			    ...
			    <td><a href="edit.php?id=<?php echo $patientId; ?>&recordtyp=activity&activityId=<?php echo $row['idA']; ?>"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Edit </span></a></td>
