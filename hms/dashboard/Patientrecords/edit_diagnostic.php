...
if(isset($_POST['submit']) && isset($_GET['entry'])){
  ...
  $diagnosticId = escape($_GET['entry']);
  
  $queryUpdate = "UPDATE diagnostic set dateDiagnostic='$date', typ='$typ', text='$text', codesys='$codesys', code='$code' WHERE idD='$diagnosticId' AND pid='$patientId'";
