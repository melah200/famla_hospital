          ...
          <div class="row">
                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">180</h3>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">800</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
			...
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left" style="color:white;background-color:#62e080;margin-top:7px;padding:3px;border-radius:5px">
                      <i class="fa fa-user-md fa-2x"></i>
                    </div>
                    <div class="float-right">
                      <p class="mb-0 text-right">Doctors</p>
                      <div class="fluid-container">
